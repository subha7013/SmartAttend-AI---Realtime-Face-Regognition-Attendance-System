...
const Login = ({ setToken }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl shadow-2xl p-8 relative z-10 transition-all duration-500 border border-slate-800">
        ...
        <div className="mt-8 pt-6 border-t border-slate-800/60 text-center">
          <p className="text-xs text-slate-500">
            For development access, register a new admin first or use standard login.
          </p>
        </div>
      </div>
    </div>
